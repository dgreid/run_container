...
pub fn from_name(name: &str) -> Result<LinuxSyscall, super::Error> {
    match name {
        ...
        "arch_prctl" => Ok(LinuxSyscall::SYS_arch_prctl),
        ...
        "tuxcall" => Ok(LinuxSyscall::SYS_tuxcall),
        "security" => Ok(LinuxSyscall::SYS_security),
        ...
        "epoll_ctl_old" => Ok(LinuxSyscall::SYS_epoll_ctl_old),
        "epoll_wait_old" => Ok(LinuxSyscall::SYS_epoll_wait_old),
        ...
        "kexec_file_load" => Ok(LinuxSyscall::SYS_kexec_file_load),
        ...
        "compat_rt_sigaction" => Ok(LinuxSyscall::compat_SYS_rt_sigaction),
        "compat_rt_sigreturn" => Ok(LinuxSyscall::compat_SYS_rt_sigreturn),
        "compat_ioctl" => Ok(LinuxSyscall::compat_SYS_ioctl),
        "compat_readv" => Ok(LinuxSyscall::compat_SYS_readv),
        "compat_writev" => Ok(LinuxSyscall::compat_SYS_writev),
        "compat_recvfrom" => Ok(LinuxSyscall::compat_SYS_recvfrom),
        "compat_sendmsg" => Ok(LinuxSyscall::compat_SYS_sendmsg),
        "compat_recvmsg" => Ok(LinuxSyscall::compat_SYS_recvmsg),
        "compat_execve" => Ok(LinuxSyscall::compat_SYS_execve),
        "compat_ptrace" => Ok(LinuxSyscall::compat_SYS_ptrace),
        "compat_rt_sigpending" => Ok(LinuxSyscall::compat_SYS_rt_sigpending),
        "compat_rt_sigtimedwait" => Ok(LinuxSyscall::compat_SYS_rt_sigtimedwait),
        "compat_rt_sigqueueinfo" => Ok(LinuxSyscall::compat_SYS_rt_sigqueueinfo),
        "compat_sigaltstack" => Ok(LinuxSyscall::compat_SYS_sigaltstack),
        "compat_timer_create" => Ok(LinuxSyscall::compat_SYS_timer_create),
        "compat_mq_notify" => Ok(LinuxSyscall::compat_SYS_mq_notify),
        "compat_kexec_load" => Ok(LinuxSyscall::compat_SYS_kexec_load),
        "compat_waitid" => Ok(LinuxSyscall::compat_SYS_waitid),
        "compat_set_robust_list" => Ok(LinuxSyscall::compat_SYS_set_robust_list),
        "compat_get_robust_list" => Ok(LinuxSyscall::compat_SYS_get_robust_list),
        "compat_vmsplice" => Ok(LinuxSyscall::compat_SYS_vmsplice),
        "compat_move_pages" => Ok(LinuxSyscall::compat_SYS_move_pages),
        "compat_preadv" => Ok(LinuxSyscall::compat_SYS_preadv),
        "compat_pwritev" => Ok(LinuxSyscall::compat_SYS_pwritev),
        "compat_rt_tgsigqueueinfo" => Ok(LinuxSyscall::compat_SYS_rt_tgsigqueueinfo),
        "compat_recvmmsg" => Ok(LinuxSyscall::compat_SYS_recvmmsg),
        "compat_sendmmsg" => Ok(LinuxSyscall::compat_SYS_sendmmsg),
        "compat_process_vm_readv" => Ok(LinuxSyscall::compat_SYS_process_vm_readv),
        "compat_process_vm_writev" => Ok(LinuxSyscall::compat_SYS_process_vm_writev),
        "compat_setsockopt" => Ok(LinuxSyscall::compat_SYS_setsockopt),
        "compat_getsockopt" => Ok(LinuxSyscall::compat_SYS_getsockopt),
        "compat_io_setup" => Ok(LinuxSyscall::compat_SYS_io_setup),
        "compat_io_submit" => Ok(LinuxSyscall::compat_SYS_io_submit),
        "compat_execveat" => Ok(LinuxSyscall::compat_SYS_execveat),
